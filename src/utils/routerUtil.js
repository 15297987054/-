...
const constantRouterComponents = {
  ...
  //class
  class:()=>import('@/views/classForm/classForm/index'),
  all:()=>import('@/views/classForm/classForm/all'),
  byClass:()=>import('@/views/classForm/classForm/byClass'),
  byClassRoom:()=>import('@/views/classForm/classForm/byClassRoom'),
  byTeacher:()=>import('@/views/classForm/classForm/byTeacher'),
  // ...more
}
          ...
          'children': [
            {
              ...
              'title': '课程表',
              'key': 'class',
              'redirect':'/classForm/classForm/all',
              'children': [
                {
                  'hiddenHeaderContent': true,
                  'title': '全部',
